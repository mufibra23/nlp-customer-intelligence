# P8 Project Setup Script
# Run from: C:\Users\ahmad\Downloads\Hack2Skill\nlp-customer-intelligence
# Usage: python setup_p8.py
...
for d in ["data/raw","data/processed","data/synthetic","models/sentiment","models/topic","src","notebooks","app","tests"]:
    os.makedirs(os.path.join(BASE_DIR, d), exist_ok=True)
    open(os.path.join(BASE_DIR, d, ".gitkeep"), "w").close()
...
with open(os.path.join(BASE_DIR, ".gitignore"), "w") as f:
    f.write("__pycache__/\n*.py[cod]\nvenv/\n.env\n.vscode/\n.idea/\ndata/raw/\ndata/processed/\ndata/synthetic/*.csv\nmodels/sentiment/\nmodels/topic/\nmodels/*.pkl\nmodels/*.joblib\n.ipynb_checkpoints/\n.DS_Store\nThumbs.db\n!data/raw/.gitkeep\n!data/processed/.gitkeep\n!data/synthetic/.gitkeep\n!models/sentiment/.gitkeep\n!models/topic/.gitkeep\n")
print("[OK] .gitignore")
...
# Helper to write files from a separate .py content
...
# 5. src/utils.py
write_file("src/utils.py", '''import os, json, time
...
# 6. src/synthetic_generator.py
write_file("src/synthetic_generator.py", '''import random, csv, os
...
# 7. src/data_pipeline.py
write_file("src/data_pipeline.py", r'''import re, os
import pandas as pd
import numpy as np
...
# 8. src/sentiment_model.py
write_file("src/sentiment_model.py", r'''"""
...
# 9. README.md
write_file("README.md", """# NLP Customer Intelligence Engine
...
subprocess.run([sys.executable, "-m", "pip", "install", "-r", os.path.join(BASE_DIR, "requirements.txt")])

# 11. GENERATE DATA
print("\nGenerating synthetic data...")
os.chdir(BASE_DIR)
subprocess.run([sys.executable, "src/synthetic_generator.py"])

# 12. RUN PIPELINE
print("\nRunning data pipeline...")
subprocess.run([sys.executable, "src/data_pipeline.py"])

# 13. INIT GIT
subprocess.run(["git", "init"], cwd=BASE_DIR)
subprocess.run(["git", "remote", "add", "origin", "https://github.com/mufibra23/nlp-customer-intelligence.git"], cwd=BASE_DIR)

print("\n" + "="*60)
print("P8 PROJECT SETUP COMPLETE!")
print("="*60)
print("\nFiles created:")
print("  src/synthetic_generator.py - 10K support tickets")
print("  src/data_pipeline.py       - text preprocessing + splits")
print("  src/sentiment_model.py     - DistilBERT fine-tuning")
print("  src/utils.py               - shared helpers")
print("  requirements.txt, .gitignore, README.md")
print("\nData generated:")
print("  data/synthetic/support_tickets.csv")
print("  data/processed/train.parquet, val.parquet, test.parquet")
print("\nNEXT: Open Claude Code and build topic_model.py, feature_engineer.py, churn_model.py, streamlit_app.py")
